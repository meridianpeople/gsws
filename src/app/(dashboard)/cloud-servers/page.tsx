...
export default function CloudServersPage() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div>
        <h1 style={{ fontSize: '20px', fontWeight: 600, color: '#0a0a0a' }}>Cloud Servers</h1>
      ...
      <div className="gsws-card" style={{ textAlign: 'center', padding: '48px' }}>
        ...
        <p style={{ fontSize: '14px', fontWeight: 600, color: '#0a0a0a', marginBottom: '6px' }}>Cloud Servers management</p>
