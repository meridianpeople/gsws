...
const nav = [
  ...
  },
  {
    label: 'Tools',
    items: [
      { label: 'Terminal', href: '/cli', icon: <Icon d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /> },
      ...
      { label: 'Legal', href: '/legal', icon: <Icon d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" d2="M9 12l2 2 4-4" />, external: true },
    ],
  },
]
