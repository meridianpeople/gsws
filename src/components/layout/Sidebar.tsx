...
const nav: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'VPS', href: '/vps', icon: <Icon d="M20 3H4a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1z M20 11H4a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1z" /> },
