    ...
    <header style={{ position: 'fixed', top: isImpersonating ? '26px' : isMember ? '26px' : 0, left: 0, right: 0, zIndex: 50, height: '52px',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '0 20px' }}>
        ...
        <button onClick={toggleTheme} title={theme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode'}
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '30px', height: '28px', borderRadius: '6px', background: 'var(--card-bg-elevated)', border: '1px solid var(--input-border)', color: 'var(--text-secondary)', cursor: 'pointer' }}>
          {theme === 'dark' ? (
